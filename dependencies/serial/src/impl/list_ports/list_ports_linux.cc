...
//static vector<string> glob(const vector<string>& patterns); //VIC
static vector<string> serial_glob(const vector<string>& patterns);
...
vector<string>
//glob(const vector<string>& patterns) //VIC
serial_glob(const vector<string>& patterns)
{
...
serial::list_ports()
{
    ...
    vector<string> devices_found = serial_glob( search_globs );
