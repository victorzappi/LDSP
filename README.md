...
- **ADBD Insecure**: a lightweight Android app massively used by XDA developers that enables ADB shells to do way more things (it remounts the phone’s file system as w/r and automatically invokes root privileges for ADB shells). 
...
- Install on laptop: open a terminal/command prompt (i.e., a shell) in the folder where you want to clone the Github repository. Choose a convenient location, since here you will find code examples and where you will likely write your code.
